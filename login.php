...
<head>
    ...
    <title>Login - Website Penelitian</title>
    <!-- Favicon-->
...
<body class="login-page" style="background-color: #209688">
    <div class="login-box">
        <div class="logo">
            ...
            <small style="font-size: 22px;margin-top: 10px">WEBSITE PENELITIAN</small>
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_in" action="aksi-login.php" method="POST">
